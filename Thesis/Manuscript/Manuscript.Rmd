...
address:
- num: a
  org: Methods and Statistics, Utrecht University, Utrecht, the Netherlands
- num: b
  org: Julius Center for Health Sciences and Primary Care, UMC Utrecht, Utrecht, the Netherlands
corres: "*Corresponding author,  \\email{h.vandebeek@uu.nl}"
...
accepted: 2017-03-01
abstract: "-"
keywords: Predictive modelling; Model selection; 
