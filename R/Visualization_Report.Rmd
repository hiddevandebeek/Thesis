...
## Experiment 1: Percentage of selecting the best performing validated model
### Function for determining best performing validated model according to cross validation



## Experiment 2: Percentage of selecting the correct model
### in series
```{r}
...
create_minimalistic_plot <- function(results_list, title_suffix = "") {
  ...
  combined_results_long <- combined_results %>%
    ...
    mutate(Criterion = factor(Criterion, levels = c("AIC_Percentage", "BIC_Percentage", "AUC_Percentage"), labels = c("AIC", "BIC", "AUC")))
...
#### all datasets
```{r}
create_minimalistic_plot(results_list.05, "with 5% Event Occurrence")
create_minimalistic_plot(results_list.2, "with 20% Event Occurrence")
create_minimalistic_plot(results_list.5, "with 50% Event Occurrence")
```
