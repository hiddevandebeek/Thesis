...
for (size in seq(50, 1000, by = 50)) {
  results_list.05[[paste("compare.05", size, sep = ".")]] <- compare_models_parallel(data, 1000, size, 0.05, 40)
}

for (size in seq(50, 1000, by = 50)) {
  results_list.2[[paste("compare.2", size, sep = ".")]] <- compare_models_parallel(data, 1000, size, 0.2, 40)
}

for (size in seq(50, 1000, by = 50)) {
  results_list.5[[paste("compare.5", size, sep = ".")]] <- compare_models_parallel(data, 1000, size, 0.5, 40)
}
```
