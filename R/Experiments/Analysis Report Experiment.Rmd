...
data1 <- readRDS("data/simulation/data experiment 1.rds")
...
saveRDS(results_list.50.1, "data/analysis/experiment 1/data_sim50.rds")
saveRDS(results_list.20.1, "data/analysis/experiment 1/data_sim20.rds")
saveRDS(results_list.05.1, "data/analysis/experiment 1/data_sim05.rds")
```
## Experiment 2: 2 predictors and full covariance
#### Run
```{r, message=FALSE, warning=FALSE, cache=T}
data2 <- readRDS("data/simulation/data experiment 2.rds")
...
saveRDS(results_list.50.2, "data/analysis/experiment 2/data_sim50.rds")
saveRDS(results_list.20.2, "data/analysis/experiment 2/data_sim20.rds")
saveRDS(results_list.05.2, "data/analysis/experiment 2/data_sim05.rds")
```
## Experiment 3: 3 predictors and partial covariance
#### Run
```{r, message=FALSE, warning=FALSE, cache=T}
data3 <- readRDS("data/simulation/data experiment 3.rds")
...
saveRDS(results_list.50.3, "data/analysis/experiment 3/data_sim50.rds")
saveRDS(results_list.20.3, "data/analysis/experiment 3/data_sim20.rds")
saveRDS(results_list.05.3, "data/analysis/experiment 3/data_sim05.rds")
```
## Experiment 4: 2 predictors and partial covariance
#### Run
```{r, message=FALSE, warning=FALSE, cache=T}
data4 <- readRDS("data/simulation/data experiment 4.rds")
...
saveRDS(results_list.50.4, "data/analysis/experiment 4/data_sim50.rds")
saveRDS(results_list.20.4, "data/analysis/experiment 4/data_sim20.rds")
saveRDS(results_list.05.4, "data/analysis/experiment 4/data_sim05.rds")
```
