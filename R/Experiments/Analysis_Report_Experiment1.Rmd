...
compare_models_parallel <- function(data, n_iter, samplesize, perc_ones, B) {
  ...
  run_iteration <- function(i) {
    ...
    return(c(aic_winner, bic_winner, auc_winner, aucvalidated_winner))
  }
...
for (size in seq(50, 1000, by = 50)) {
  results_list.05[[paste("compare.05", size, sep = ".")]] <- compare_models_parallel(data, 500, size, 0.05, 80)
}

for (size in seq(50, 1000, by = 50)) {
  results_list.20[[paste("compare.20", size, sep = ".")]] <- compare_models_parallel(data, 500, size, 0.2, 80)
}

for (size in seq(50, 1000, by = 50)) {
  results_list.50[[paste("compare.50", size, sep = ".")]] <- compare_models_parallel(data, 500, size, 0.5, 80)
}
