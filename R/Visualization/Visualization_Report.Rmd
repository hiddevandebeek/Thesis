...
### function
```{r}
create_plot <- function(results_list, title_suffix = "") {
...
### all datasets
```{r}
plot.05 <- create_plot(results_list.05, "5% Event Occurrence")
plot.20 <- create_plot(results_list.20, "20% Event Occurrence")
plot.50 <- create_plot(results_list.50, "50% Event Occurrence")
```
...
ggsave("/Users/hiddevandebeek/Documents/Documents - Hidde’s MacBook Pro/Github/Thesis/results/experiment 1/plot.20.png", plot.20, width = 8, height = 6, units = "in", dpi = 1000)
ggsave("/Users/hiddevandebeek/Documents/Documents - Hidde’s MacBook Pro/Github/Thesis/results/experiment 1/plot.50.png", plot.50, width = 8, height = 6, units = "in", dpi = 1000)
```
