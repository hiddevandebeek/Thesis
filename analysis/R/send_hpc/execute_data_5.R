...
a_values_5predictors_covariance <- read.csv("/home/julius_bs/hvandebeek/analysis/data/datasets/a_values/5predictors_covariance.csv")

mu0 <- c(rep(1,npred))  
sigma0 <- scenario()
data_experiment <- mvrnorm(n, mu = mu0, Sigma = sigma0) 
colnames(data_experiment) <- c(paste0("predictor", 1:(ncol(data_experiment))))
saveRDS(data_experiment, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/data_predictors.rds")
...
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/1normal.rds")
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/1interaction.rds")
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/2normal.rds")
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/2normalinteraction.rds")
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/2interaction.rds")

# Part 2: ANTI
## Covariance
## 1 end predictor: normal anti
a <- a_values_5predictors_covariance$AUC_0.6[1]
L <-  calculate_linear_predictor5(a, data_experiment, "sparse")
L <- - mean(L) + L
y_0.6 <- ifelse(runif(n) < plogis(L), 1, 0)
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/1normal_anti.rds")
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/1interaction_anti.rds")

## 2 end predictor: normal + normal anti
a <- a_values_5predictors_covariance$AUC_0.6[3]
L <-  calculate_linear_predictor5(a, data_experiment, "minimal")
L <- - mean(L) + L
y_0.6 <- ifelse(runif(n) < plogis(L), 1, 0)
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/2normal_anti.rds")
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/2normalinteraction_anti.rds")
...
y_0.9 <- ifelse(runif(n) < plogis(L), 1, 0)
y <- cbind(y_0.6, y_0.75, y_0.9)
saveRDS(y, "/home/julius_bs/hvandebeek/analysis/data/datasets/full_data/5pred/covar/2interaction_anti.rds")
