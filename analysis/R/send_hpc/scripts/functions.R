...
calculate_linear_predictor5 <- function(a, data, scenario) {
  ...
  if (scenario == "normal") {
    ...
    return(a * (data$predictor1 + data$predictor2 + data$predictor3 + data$predictor4))
  } else if (scenario == "minimal") {
    return(a * (data$predictor1 + data$predictor2 + data$predictor3))
  }
}
calculate_linear_predictor10 <- function(a, data, scenario) {
  ...
  if (scenario == "normal") {
    ...
    return(a * (data$predictor1 + data$predictor2 + data$predictor3 + data$predictor4 + 0.5*data$predictor1*data$predictor2 + data$predictor6 + data$predictor7 + data$predictor8 + data$predictor9 + data$predictor10))
  } else if (scenario == "2 normal") {
    ...
    return(a * (data$predictor1 + data$predictor2 + data$predictor3 + 0.5*data$predictor1*data$predictor2 + 0.5*data$predictor4 + data$predictor6 + data$predictor7 + data$predictor8 + data$predictor9 + data$predictor10))
  } else if (scenario == "2 interaction") {
    return(a * (data$predictor1 + data$predictor2 + data$predictor3 + 0.5*data$predictor1*data$predictor2 + 0.5*data$predictor2*data$predictor3 + data$predictor6 + data$predictor7 + data$predictor8 + data$predictor9 + data$predictor10))
  } else if (scenario == "sparse") {
    return(a * (data$predictor1 + data$predictor2 + data$predictor3 + data$predictor4 + data$predictor6 + data$predictor7 + data$predictor8 + data$predictor9 + data$predictor10))
  } else if (scenario == "minimal") {
    return(a * (data$predictor1 + data$predictor2 + data$predictor3 + data$predictor6 + data$predictor7 + data$predictor8 + data$predictor9 + data$predictor10))
  }
}
...
compare_models_05_mclapply <- function(data, true_auc, scenario, perc_ones, n_iter = 2, sample_range = c(50, 1000), sample_steps = 50, B = 80, seed = 28, iteration = 0, covar = T, anti = F, cl = (detectCores()-1)) {
